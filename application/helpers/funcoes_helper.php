...
function converterNumeroToString($moeda) {
	return ($moeda) ? str_replace(",", ".", str_replace(".", "", $moeda)) : null;
}
...
function modulo11($num, $base=9, $r=0) {
	 ...
	 *    de boletos bancarios conforme documentos obtidos da Febraban - www.febraban.org.br
	 *
	 *   Entrada:
