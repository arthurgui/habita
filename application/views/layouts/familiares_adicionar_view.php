			...
			<?= form_open($consultar, $form_attr); ?>
				<div class="card border border-gray-light">
					<div class="card-header bg-brand-primary fc-white m-1">
						<h5><i class="fas fa-user"></i>&nbsp;&nbsp;Adicionar Componente Famialiar</h5>
					</div>
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-4 form-inline">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" class="custom-control-input" id="sexo_m" name="sexo" value="M" checked>
									<label class="custom-control-label" for="sexo_m">Masculino</label>
								</div>
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" class="custom-control-input" id="sexo_f" name="sexo" value="F">
						...
						<div class="form-group row">
							...
							<div class="col-5">
								<?= form_dropdown('ce_grau_parentesco', $opt_grau_parentesco, '', $grau_parentesco); ?>
						...
						<div class="form-group row">
							...
							<div class="col form-inline">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" class="custom-control-input" id="sn_atividade_remunerada_s" name="sn_atividade_remunerada" value="S">
									<label class="custom-control-label" for="sn_atividade_remunerada_s">Sim</label>
								</div>
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" class="custom-control-input" id="sn_atividade_remunerada_n" name="sn_atividade_remunerada" value="N" checked>
						...
						<div class="bg-light opt-atividade-remunerada d-none">
							...
							<div class="form-group row align-items-center">
								...
								<div class="col-3">
									<?= form_dropdown('ce_tipo_vinculo', $opt_tipo_vinculo, '', $tipo_vinculo); ?>
						...
						<div class="form-group row">
							...
							<div class="col form-inline">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" class="custom-control-input" id="sn_deficiencia_s" name="sn_deficiencia" value="S">
									<label class="custom-control-label" for="sn_deficiencia_s">Sim</label>
								</div>
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" class="custom-control-input" id="sn_deficiencia_n" name="sn_deficiencia" value="N" checked>
