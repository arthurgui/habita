<?php
	...
	// Titular
		...
		$tempo_atividade	=	array(
									...
									'type'			=>	'text',
									'class'			=>	'form-control',
									'value'			=>	set_value("tempo_atividade"),
									'placeholder'	=>	'',
									'maxlength'		=>	'25'
								);
		$renda				=	array(
									...
									'placeholder'	=>	'',
									'maxlength'		=>	'14',
									//'onkeyup'		=>	"return txtBoxFormat(this, '000,00', event);"
	...
	// Composição Famíliar
		...
		$tempo_atividade_cf	=	array(
									'id'			=>	'inc_tempo_atividade_cf',
									'name'			=>	'inc_tempo_atividade_cf',
									'type'			=>	'text',
									'class'			=>	'form-control',
									'value'			=>	set_value("inc_tempo_atividade_cf"),
									'placeholder'	=>	'',
									'maxlength'		=>	'25'
								);
		$renda_cf			=	array(
						...
						<div class="tab-content" id="nav-tabContent">
							...
							<div class="tab-pane fade" id="nav-conjuge" role="tabpanel" aria-labelledby="nav-conjuge-tab">
								...
								<div class="opt-adicionar-conjuge d-none">
									...
									<div class="form-group row">
										<?= form_label('Celular:', 'telefone_cj', $label2); ?>
										<div class="col-3">
											<?= form_input($telefone_cj); ?>
											<font color="red"><?= form_error('telefone_cj'); ?></font>
										</div>
									</div>
									<div class="form-group row">
								...
								<div class="card card-add-familiar mt-4 mb-4">
									...
									<div class="card-body">
										...
										<div class="bg-light opt-atividade-remunerada-cf d-none">
											...
											<div class="form-group row">
												<?= form_label('Tempo:', 'inc_tempo_atividade_cf', $label4); ?>
												<div class="col-3">
													<?= form_input($tempo_atividade_cf); ?>
													<font color="red"><?= form_error('inc_tempo_atividade_cf'); ?></font>
												</div>
											</div>
											<div class="form-group row pb-2">
							...
							<div class="tab-pane fade" id="nav-saude" role="tabpanel" aria-labelledby="nav-saude-tab">
								...
								<fieldset class="mt-4">
									...
									<div class="form-group row">
										<?= form_label('Possui Esgoto:', 'sn_esgoto', $label3); ?>
										<div class="col form-inline">
											<div class="custom-control custom-radio custom-control-inline">
