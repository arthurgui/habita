		...
		<div class="col-12">
			<div class="card border border-green-system">
				<div class="card-header bg-brand-primary fc-white m-1">
					<h5><i class="fa fa-user-circle"></i>&nbsp;&nbsp;<?= $nome_usuario; ?></h5>
				</div>
					...
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="chcksenha" name="chcksenha" value="S">
								<label class="custom-control-label" for="chcksenha">Atualizar senha</label>
							</div>
						</div>
					</div>
