			...
			<div class="card border border-gray-light">
				...
				<div class="card-body">
					...
					<div class="navbar navbar-default mb-2">
						<a class="btn btn-brand-primary" href=<?= base_url("cad_cadastros/adicionar_campo/$cadastro->id"); ?> data-toggle="tooltip" title="Adicionar"><i class="fa fa-plus"></i>&nbsp;Adicionar</a>
					</div>
